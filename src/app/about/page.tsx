 ...
 * FIXED: ease typing issue for Vercel build
 * ============================================================================
 */
      ...
      <section className="px-6 lg:px-12 max-w-[1440px] mx-auto mb-32">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-white border border-purple-100 shadow-sm"
          >
            <Sparkles size={16} className="text-purple-600" />
            <span className="text-[10px] font-black text-gray-900 uppercase tracking-[0.4em]">
              Section 00 / Institutional Profile
            </span>
          </motion.div>

          <motion.h1
            variants={itemVariants}
            className="text-7xl lg:text-[110px] font-black text-gray-900 leading-[0.8] tracking-tighter uppercase"
          >
            Defining The <br />
            <span className="bg-gradient-to-r from-purple-600 via-pink-500 to-purple-600 bg-clip-text text-transparent italic">
              Future Code.
            </span>
          </motion.h1>
          ...
          <motion.p
            variants={itemVariants}
            className="max-w-3xl text-xl md:text-2xl text-gray-400 font-medium italic leading-relaxed"
          >
            "CODE IT Software Training Institute delivers industry-focused IT protocols, emphasizing
            practical architecture and career deployment readiness."
          </motion.p>
        </motion.div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-20">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-xs font-black text-gray-900 uppercase tracking-[0.6em]">
                  Our Vision Protocol
                </h2>
              </div>

              <p className="text-3xl font-bold text-gray-900 tracking-tight leading-snug italic">
                "To empower professionals with real-world skills and build strong IT careers through
                quality training and continuous guidance."
              </p>
            </motion.div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {MISSION_ITEMS.map((item, idx) => (
                  ...
                  >
                    <item.icon
                      size={28}
                      className="text-purple-300 group-hover:text-purple-600 transition-colors"
                    />
                    <div>
      ...
      <section className="py-48 px-6 lg:px-12 max-w-[1440px] mx-auto text-center">
        ...
        >
          <h3 className="text-5xl lg:text-7xl font-black text-gray-900 tracking-tighter uppercase leading-none">
            ...
            <span className="text-purple-600">Academia</span> &{' '}
            <span className="text-pink-500">Industry.</span>
          </h3>
          ...
          <p className="max-w-2xl mx-auto text-gray-500 font-medium leading-relaxed">
            Established in 2021, CODE IT has evolved into the region's premier hub for technical
            excellence, training over 500+ professionals for the global digital economy.
          </p>
        </motion.div>
      </section>
